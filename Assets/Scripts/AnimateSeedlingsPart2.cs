...
public class AnimateSeedlingsPart2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        gameObject.AddComponent<ChuckEventListener>().ListenForEvent( theChuck, "part2SeedlingNotePlayed", LaunchASeedling );
    }
    ...
    void LaunchASeedling()
    {
		...
		Vector3 seedlingVelocity = 0.25f * Part2CommunicateWavingHand.mostRecentGestureDirection + 0.02f * RandomVector3();
